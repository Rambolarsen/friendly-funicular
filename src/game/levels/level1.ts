...
export const level1: LevelData = {
  ...
  enemies: [
    { type: EnemyType.Goblin,   x: 300,  y: 440 },
    { type: EnemyType.Goblin,   x: 750,  y: 440 },
    { type: EnemyType.Wraith,   x: 900,  y: 440 },
    { type: EnemyType.Goblin,   x: 1100, y: 440 },
    { type: EnemyType.Troll,    x: 1350, y: 440 },
    { type: EnemyType.Wraith,   x: 1550, y: 440 },
    { type: EnemyType.Spectre,  x: 1800, y: 440 },
    { type: EnemyType.Goblin,   x: 2000, y: 440 },
    { type: EnemyType.Troll,    x: 2150, y: 440 },
    { type: EnemyType.Spectre,  x: 2500, y: 440 },
    { type: EnemyType.Wraith,   x: 2700, y: 440 },
    { type: EnemyType.Troll,    x: 2950, y: 440 },
  ],
  loots: [
